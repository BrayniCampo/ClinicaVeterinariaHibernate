...
import com.brayni.dao.MascotaDao;
import com.brayni.entidades.*;
...
public class EliminarMasctoasGui extends JDialog implements ActionListener{
	...
	public EliminarMasctoasGui(VentanaPrincipal ventanaPrincipal, boolean modal) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnEliminar) {
			...
			if(verificarEliminacion.equals("perfecto")) {
				...
				this.dispose();
				System.out.println("ALGO PASÓ. ERROOOOOR");
			}
